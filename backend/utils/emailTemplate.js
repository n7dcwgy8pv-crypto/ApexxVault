...
/**
 * Generate rich HTML invoice for Resend email delivery
 */
    ...
    <tr style="border-bottom: 1px solid #e2e8f0;">
      <td style="padding: 12px; font-weight: 600; color: #0f172a;">
        ...
        <div style="font-size: 12px; color: #64748b; font-family: monospace; margin-top: 4px;">
          SKU: ${item.product?.sku || item.sku || 'N/A'} | Condition: ${item.product?.condition || item.condition || 'Brand New'} | Location: ${item.product?.warehouseLocation || 'Unit #32'}
        </div>
      </td>
